...
import net.mcreator.kimetsunoyaibareload.procedures.SeeThroughWorldPressedProcedure;
...
public class SeeThroughWorldKeyBinding extends KnyrModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public SeeThroughWorldKeyBinding(KnyrModElements instance) {
		super(instance, 12);
	...
	public void initElements() {
		keys = new KeyBinding("key.knyr.see_through_world", GLFW.GLFW_KEY_O, "key.categories.knyr");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			SeeThroughWorldPressedProcedure
